import { ColorConverter } from '../../bmp/utils/bytes-utils.js';
import { getPaddingBytesPerRow, getPixelsBytesPerRow } from '../../bmp/utils/bmp-utils.js';
...
export function bmpData2TopRightImage(data, dataOffset, width, height, bytesPerPixel) {
